'''
res50,101, 152 seems OK
34, 18 has channel number problem
'''
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("c:",c2.size(),c3.size(),c4.size(),c5.size())
        ...
        out = self.conv3(out)
        #print("before upsample out:",out.size())
...
def test_main():
    model = resnet50(pretrained=True,num_classes=16)
    img = torch.rand(32,3,196,256)
    res = model(img)
    print(res.size())
